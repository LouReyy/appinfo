...
?>
         ...
         <div id = 'topic<?php echo $i ?>' class = topic>
             ...
             <a  class="<?php echo $button ?>"  href="/appinfo/faq/model/supprimer-question.php?id=<?php echo $row['id_question']?>">Supprimer</a> 

                <img id = 'fleche<?php echo $i ?>' src ="/appinfo/faq/img/fleche.png" class = fleche>
         </div>
